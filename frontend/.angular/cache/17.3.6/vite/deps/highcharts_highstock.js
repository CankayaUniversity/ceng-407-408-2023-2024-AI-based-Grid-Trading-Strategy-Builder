 ...
 - ${i4}: ${e4}`, l2 && (h2 += encodeURI(i4) + "=" + encodeURI(e4));
        ...
        function p(t3 = "", e3, o2) {
          ...
          return l2.forEach((i3) => {
            ...
            if (u2) {
              ...
              for (r2 = c[u2].length; r2--; )
                t4.unshift(y(h2[r2 + 1]));
        ...
        return (e2 || (e2 = {})).distribute = function t3(e3, a, n) {
          ...
          for (f = p; f--; )
            S += e3[f].size;
          if (S > h) {
            for (r(e3, (t4, e4) => (e4.rank || 0) - (t4.rank || 0)), x = (k = e3[0].rank === e3[e3.length - 1].rank) ? p / 2 : -1, m = k ? x : p - 1; x && S > h; )
        ...
        class B {
          ...
          getBBox(t3, e3) {
            ...
            if (x(d2) && (-1 === (r2 = d2.toString()).indexOf("<") && (r2 = r2.replace(/[0-9]/g, "0")), r2 += ["", l2.rootFontSize, f2, g2, this.textWidth, a2, h2.textOverflow, h2.fontWeight].join(",")), r2 && !t3 && (i3 = c2[r2]), !i3) {
              if (u2 || l2.forExport) {
                try {
          ...
          setTextPath(t3, e3) {
            e3 = A(true, { enabled: true, attributes: { dy: -5, startOffset: "50%", textAnchor: "middle" } }, e3);
            ...
            if (t3 = t3 || o2 && o2.path, o2 && o2.undo(), t3 && a2) {
              let e4 = p(s2, "afterModifyTree", (e5) => {
                if (t3 && a2) {
                  ...
                  o3 || t3.attr("id", o3 = E());
                  let a3 = { x: 0, y: 0 };
                  x(r2.dx) && (a3.dx = r2.dx, delete r2.dx), x(r2.dy) && (a3.dy = r2.dy, delete r2.dy), s2.attr(a3), this.attr({ transform: "" }), this.box && (this.box = this.box.destroy());
                  let n2 = e5.nodes.slice(0);
                  e5.nodes.length = 0, e5.nodes[0] = { tagName: "textPath", attributes: b(r2, { "text-anchor": r2.textAnchor, href: `${i3}#${o3}` }), children: n2 };
                }
              });
          ...
          shadow(t3) {
            let { renderer: e3 } = this, i3 = A(this.parentGroup?.rotation === 90 ? { offsetX: -1, offsetY: -1 } : {}, M(t3) ? t3 : {}), s2 = e3.shadowDefinition(i3);
          ...
          zIndexSetter(t3, e3) {
            ...
            if (x(t3) ? (r2.setAttribute("data-z-index", t3), t3 = +t3, this[e3] === t3 && (p2 = false)) : x(this[e3]) && r2.removeAttribute("data-z-index"), this[e3] = t3, p2) {
              for ((t3 = this.zIndex) && s2 && (s2.handleZ = true), u2 = (n2 = o2.childNodes).length - 1; u2 >= 0 && !d2; u2--)
                c2 = !x(h2 = (l2 = n2[u2]).getAttribute("data-z-index")), l2 !== r2 && (t3 < 0 && c2 && !a2 && !u2 ? (o2.insertBefore(r2, n2[u2]), d2 = true) : (P(h2) <= t3 || c2 && (!x(t3) || t3 >= 0)) && (o2.insertBefore(r2, n2[u2 + 1]), d2 = true));
        ...
        function o(t3, i3, o2, r2, a2) {
          let n = [];
          if (a2) {
            let l = a2.start || 0, h = s(a2.r, o2), d = s(a2.r, r2 || o2), c = 2e-4 / Math.max(h, 1), p = Math.abs((a2.end || 0) - l - 2 * Math.PI) < c, u = (a2.end || 0) - c, g = a2.innerR, f = s(a2.open, p), m = Math.cos(l), x = Math.sin(l), y = Math.cos(u), b = Math.sin(u), v = s(a2.longArc, u - l - Math.PI < c ? 0 : 1), S = ["A", h, d, 0, v, s(a2.clockwise, 1), t3 + h * y, i3 + d * b];
        ...
        class N {
          ...
          setSize(t3, e3, i3) {
            ...
            }, duration: I(i3, true) ? void 0 : 0 }), this.alignElements();
          }
          g(t3) {
          ...
          symbol(t3, e3, i3, s2, o2, r2) {
            ...
            if (m2)
              "number" == typeof e3 && (n2 = m2.call(this.symbols, e3 || 0, i3 || 0, s2 || 0, o2 || 0, r2)), a2 = this.path(n2), d2.styledMode || a2.attr("fill", "none"), O(a2, { symbolName: f2 || void 0, x: e3, y: i3, width: s2, height: o2 }), r2 && O(a2, r2);
            else if (u2) {
              l2 = t3.match(c2)[1];
              let s3 = a2 = this.image(l2);
              s3.imgwidth = I(r2 && r2.width, v[l2] && v[l2].width), s3.imgheight = I(r2 && r2.height, v[l2] && v[l2].height), h2 = (t4) => t4.attr({ width: t4.width, height: t4.height }), ["width", "height"].forEach((t4) => {
              ...
              }), T(e3) && s3.attr({ x: e3, y: i3 }), s3.isImg = true, T(s3.imgwidth) && T(s3.imgheight) ? h2(s3) : (s3.attr({ width: 0, height: 0 }), C("img", { onload: function() {
          ...
          pathToSegments(t3) {
            ...
            for (let o2 = 0; o2 < t3.length; o2++)
              B(i3[0]) && D(t3[o2]) && i3.length === s2[i3[0].toUpperCase()] && t3.splice(o2, 0, i3[0].replace("M", "L").replace("m", "l")), "string" == typeof t3[o2] && (i3.length && e3.push(i3.slice(0)), i3.length = 0), i3.push(t3[o2]);
          ...
          addLabel() {
            ...
            O ? e3.shortenLabel = function() {
              for (C = 0; C < O.length; C++)
                if (l(w, { dateTimeLabelFormat: O[C] }), S.attr({ text: T.call(w, w) }), S.getBBox().width < i3.getSlotWidth(e3) - 2 * (f.padding || 0))
                  return;
              S.attr({ text: "" });
        ...
        class G {
          ...
          getPlotLinePath(t3) {
            ...
            return M(this, "getPlotLinePath", v2, function(t4) {
              u2 = f2 = (c2 = m(c2 = E(c2, e3.translate(a2, void 0, void 0, r2)), -1e5, 1e5)) + d2, g2 = x2 = l2 - c2 - d2, T(c2) ? e3.horiz ? (g2 = o2, x2 = l2 - e3.bottom + (i3.scrollablePixelsY || 0), u2 = f2 = b2(u2, s2, s2 + e3.width)) : (u2 = s2, f2 = h2 - e3.right + (i3.scrollablePixelsX || 0), g2 = x2 = b2(g2, o2, o2 + e3.height)) : (y2 = true, p2 = false), t4.path = y2 && !p2 ? void 0 : i3.renderer.crispLine([["M", u2, g2], ["L", f2, x2]], n2 || 1);
            }), v2.path;
          }
          ...
          setTickPositions() {
            ...
            this.tickPositions = n2, this.paddedTicks = n2.slice(0), this.trimTicks(n2, r2, a2), !this.isLinked && T(this.min) && T(this.max) && (this.single && n2.length < 2 && !this.categories && !this.series.some((t4) => t4.is("heatmap") && "between" === t4.options.pointPlacement) && (this.min -= 0.5, this.max += 0.5), e3 || l2 || this.adjustTickAmount()), M(this, "afterSetTickPositions");
          }
          trimTicks(t3, e3, i3) {
          ...
          setScale() {
            ...
            o2 || i3 || s2 || this.isLinked || this.forceRedraw || this.userMin !== (this.old && this.old.userMin) || this.userMax !== (this.old && this.old.userMax) || this.alignToOthers() ? (e3 && "yAxis" === t3 && e3.buildStacks(), this.forceRedraw = false, this.userMinRange || (this.minRange = void 0), this.getSeriesExtremes(), this.setTickInterval(), e3 && "xAxis" === t3 && e3.buildStacks(), this.isDirty || (this.isDirty = o2 || this.min !== this.old?.min || this.max !== this.old?.max)) : e3 && e3.cleanStacks(), i3 && delete this.allExtremes, M(this, "afterSetScale");
          }
          ...
          unsquish() {
            ...
            if (i3) {
              if (!t3.staggerLines && (T(r2) ? p2 = [r2] : o2 < t3.autoRotationLimit && (p2 = t3.autoRotation)), p2) {
                let t4, e4;
                for (let i4 of p2)
                  (i4 === r2 || i4 && i4 >= -90 && i4 <= 90) && (e4 = (t4 = l2(Math.abs(a2 / Math.sin(u * i4)))) + Math.abs(i4 / 360)) < c2 && (c2 = e4, d2 = i4, h2 = t4);
              }
            } else
              h2 = l2(0.75 * a2);
        ...
        class c {
          ...
          render() {
            n(this, "render");
            let { axis: t3, options: e3 } = this, { horiz: i3, logarithmic: s2 } = t3, { color: r2, events: a2, zIndex: c2 = 0 } = e3, p = {}, u = t3.chart.renderer, g = e3.to, f = e3.from, m = e3.value, x = e3.borderWidth, y = e3.label, { label: b, svgElem: v } = this, S = [], k, M = o(f) && o(g), C = o(m), A = !v, w = { class: "highcharts-plot-" + (M ? "band " : "line ") + (e3.className || "") }, T = M ? "bands" : "lines";
            if (!t3.chart.styledMode && (C ? (w.stroke = r2 || "#999999", w["stroke-width"] = d(e3.width, 1), e3.dashStyle && (w.dashstyle = e3.dashStyle)) : M && (w.fill = r2 || "#e6e9ff", x && (w.stroke = e3.borderColor, w["stroke-width"] = x))), p.zIndex = c2, T += "-" + c2, (k = t3.plotLinesAndBandsGroups[T]) || (t3.plotLinesAndBandsGroups[T] = k = u.g("plot-" + T).attr(p).add()), v || (this.svgElem = v = u.path().attr(w).add(k)), o(m))
            ...
            }), this.eventsAdded = true), (A || !v.d) && S?.length ? v.attr({ d: S }) : v && (S ? (v.show(), v.animate({ d: S })) : v.d && (v.hide(), b && (this.label = b = b.destroy()))), y && (o(y.text) || o(y.formatter)) && S?.length && t3.width > 0 && t3.height > 0 && !S.isFlat ? (y = l({ align: i3 && M ? "center" : void 0, x: i3 ? !M && 4 : 10, verticalAlign: !i3 && M ? "middle" : void 0, y: i3 ? M ? 16 : 10 : M ? 6 : -4, rotation: i3 && !M ? 90 : 0 }, y), this.renderLabel(y, S, M, c2)) : b && b.hide(), this;
          }
        ...
        class T {
          ...
          getAnchor(t3, e3) {
            ...
            if ((t3 = A(t3))[0].series && t3[0].series.yAxis && !t3[0].series.yAxis.options.reversedStacks && (t3 = t3.slice().reverse()), this.followPointer && e3)
          ...
          getLabel() {
            let t3 = this, e3 = this.chart.styledMode, s2 = this.options, r2 = this.split && this.allowShared, a2 = this.container, n2 = this.chart.renderer;
            if (this.label) {
          ...
          refresh(t3, e3) {
            let { chart: i3, options: s2, pointer: o2, shared: a2 } = this, n2 = A(t3), h2 = n2[0], d2 = [], c2 = s2.format, p2 = s2.formatter || this.defaultFormatter, u2 = i3.styledMode, g2 = {};
            ...
            let v2 = S(c2) ? l(c2, g2, i3) : p2.call(g2, this), k2 = h2.series;
            if (this.distance = M(k2.tooltipOptions.distance, 16), false === v2)
              this.hide();
            else {
              if (this.split && this.allowShared)
                ...
                let t4 = m2, r2 = x2;
                if (e3 && o2.isDirectTouch && (t4 = e3.chartX - i3.plotLeft, r2 = e3.chartY - i3.plotTop), i3.polar || false === k2.options.clip || n2.some((e4) => o2.isDirectTouch || e4.series.shouldShowTooltip(t4, r2))) {
                  let t5 = this.getLabel();
                  (!s2.style.width || u2) && t5.css({ width: (this.outside ? this.getPlayingField() : i3.spacingBox).width + "px" }), t5.attr({ text: v2 && v2.join ? v2.join("") : v2 }), t5.addClass(this.getClassName(h2), true), u2 || t5.attr({ stroke: s2.borderColor || h2.color || k2.color || "#666666" }), this.updatePosition({ plotX: m2, plotY: x2, negative: h2.negative, ttBelow: h2.ttBelow, h: f2[2] || 0 });
                } else {
                  this.hide();
                  return;
                }
          ...
          renderSplit(t3, e3) {
            ...
            let I = t3.slice(0, e3.length + 1).reduce(function(t4, s3, o3) {
              if (false !== s3 && "" !== s3) {
                ...
                let { anchorX: x2, anchorY: v3 } = function(t5) {
                  ...
                  if (s4)
                    e4 = Math.max(n2 + o4, n2), i4 = l2 + a2 / 2;
                  else {
            ...
            if (G && z && N) {
              ...
              N.setSize(t4 + i4, e4 + s3, false), z.style.left = R.left + "px", z.style.top = L + "px";
            }
        ...
        class M {
          ...
          applyOptions(t3, e3) {
            ...
            return c(this, t3 = M.prototype.optionsToObject.call(this, t3)), this.options = this.options ? c(this.options, t3) : t3, t3.group && delete this.group, t3.dataLabels && delete this.dataLabels, s2 && (this.y = M.prototype.getNestedProperty.call(this, s2)), this.selected && (this.state = "select"), "name" in this && void 0 === e3 && i3.xAxis && i3.xAxis.hasNames && (this.x = i3.xAxis.nameToX(this)), void 0 === this.x && i3 ? void 0 === e3 ? this.x = i3.autoIncrement() : this.x = e3 : m(t3.x) && i3.options.relativeXValue && (this.x = i3.autoIncrement(t3.x)), this.isNull = this.isValid && !this.isValid(), this.formatPrefix = this.isNull ? "null" : "point", this;
          }
          destroy() {
            if (!this.destroyed) {
          ...
          optionsToObject(t3) {
            ...
            if (m(t3) || null === t3)
              ...
              for (!i3 && t3.length > o2 && ("string" == (a2 = typeof t3[0]) ? r2.name = t3[0] : "number" === a2 && (r2.x = t3[0]), n2++); l2 < o2; )
                i3 && void 0 === t3[n2] || (s2[l2].indexOf(".") > 0 ? M.prototype.setNestedProperty(r2, t3[n2], s2[l2]) : r2[s2[l2]] = t3[n2]), n2++, l2++;
            else
          ...
          update(t3, e3, i3, s2) {
            ...
            function d2() {
              ...
              n2 && d3 && (r2.graphic = n2.destroy(), delete r2.hasMockGraphic), x(t3, true) && (n2 && n2.element && t3 && t3.marker && void 0 !== t3.marker.symbol && (r2.graphic = n2.destroy()), t3?.dataLabels && r2.dataLabel && (r2.dataLabel = r2.dataLabel.destroy())), o2 = r2.index, a2.updateParallelArrays(r2, o2), h2.data[o2] = x(h2.data[o2], true) || x(t3, true) ? r2.options : b(t3, h2.data[o2]), a2.isDirty = a2.isDirtyData = true, !a2.fixedBox && a2.hasCartesianSeries && (l2.isDirtyBox = true), "point" === h2.legendType && (l2.isDirtyLegend = true), e3 && l2.redraw(i3);
            }
          ...
          manageEvent(t3) {
            ...
            f(i3) && (!this.hcEvents?.[t3] || this.hcEvents?.[t3]?.map((t4) => t4.fn).indexOf(i3) === -1) ? (l(this, t3, i3), this.hasImportedEvents = true) : this.hasImportedEvents && !i3 && this.hcEvents?.[t3] && (S(this, t3), delete this.hcEvents[t3], Object.keys(this.hcEvents) || (this.hasImportedEvents = false));
          }
          setState(e3, i3) {
            ...
            if ((e3 = e3 || "") === this.state && !i3 || this.selected && "select" !== e3 || false === r2.enabled || e3 && (d2 || l2 && false === h2.enabled) || e3 && u2.states && u2.states[e3] && false === u2.states[e3].enabled)
              return;
            if (this.state = e3, f2 && (y2 = s2.markerAttribs(this, e3)), this.graphic && !this.hasMockGraphic) {
              ...
              e3 && h2 && (M2 = u2.symbol || s2.symbol, k2 && k2.currentSymbol !== M2 && (k2 = k2.destroy()), y2 && (k2 ? k2[i3 ? "animate" : "attr"]({ x: y2.x, y: y2.y }) : M2 && (s2.stateMarkerGraphic = k2 = g2.renderer.symbol(M2, y2.x, y2.y, y2.width, y2.height).add(s2.markerGroup), k2.currentSymbol = M2)), !g2.styledMode && k2 && "inactive" !== this.state && k2.attr(s2.pointAttribs(this, e3))), k2 && (k2[e3 && this.isInside ? "show" : "hide"](), k2.element.point = this, k2.addClass(this.getClassName(), true));
            let C = r2.halo, A = this.graphic || k2, w = A && A.visibility || "inherit";
            C && C.size && A && "hidden" !== w && !this.isCluster ? (x2 || (s2.halo = x2 = g2.renderer.path().add(A.parentGroup)), x2.show()[i3 ? "animate" : "attr"]({ d: this.haloPath(C.size) }), x2.attr({ class: "highcharts-halo highcharts-color-" + b(this.colorIndex, s2.colorIndex) + (this.className ? " " + this.className : ""), visibility: w, zIndex: -1 }), x2.point = this, g2.styledMode || x2.attr(c({ fill: this.color || s2.color, "fill-opacity": C.opacity }, t2.filterUserAttributes(C.attributes || {})))) : x2?.point?.haloPath && !x2.point.destroyed && x2.animate({ d: x2.point.haloPath(0) }, null, x2.hide), p(this, "afterSetState", { state: e3 });
          }
          haloPath(t3) {
            let e3 = this.pos();
        ...
        class S {
          ...
          onDocumentMouseUp(t3) {
            r[y(S.hoverChartIndex, -1)]?.pointer?.drop(t3);
          }
          pinch(t3) {
            let e3 = this, { chart: i3, hasZoom: s2, lastTouches: o2 } = e3, r2 = [].map.call(t3.touches || [], (t4) => e3.normalize(t4)), a2 = r2.length, n2 = 1 === a2 && (e3.inClass(t3.target, "highcharts-tracker") && i3.runTrackerClick || e3.runChartClick), l2 = i3.tooltip, h2 = 1 === a2 && y(l2?.options.followTouchMove, true);
            a2 > 1 ? e3.initiated = true : h2 && (e3.initiated = false), s2 && e3.initiated && !n2 && false !== t3.cancelable && t3.preventDefault(), "touchstart" === t3.type ? (e3.pinchDown = r2, e3.res = true) : h2 ? this.runPointActions(e3.normalize(t3)) : o2 && (u(i3, "touchpan", { originalEvent: t3, touches: r2 }, () => {
              let e4 = (t4) => {
          ...
          runPointActions(t3, e3, i3) {
            ...
            this.unDocMouseMove || (this.unDocMouseMove = l(s2.container.ownerDocument, "mousemove", (t4) => r[S.hoverChartIndex ?? -1]?.pointer?.onDocumentMouseMove(t4)), this.eventsToUnbind.push(this.unDocMouseMove)), s2.axes.forEach(function(e4) {
              let i4;
        ...
        var a;
        let { animObject: n, setAnimation: l } = t2, { format: h } = e2, { composed: d, marginNames: c } = i2, { distribute: p } = o, { addEvent: u, createElement: g, css: f, defined: m, discardElement: x, find: y, fireEvent: b, isNumber: v, merge: S, pick: k, pushUnique: M, relativeLength: C, stableSort: A, syncTimeout: w } = r;
        class T {
          constructor(t3, e3) {
          ...
          layoutItem(t3) {
            let e3 = this.options, i3 = this.padding, s2 = "horizontal" === e3.layout, o2 = t3.itemHeight, r2 = this.itemMarginBottom, a2 = this.itemMarginTop, n2 = s2 ? k(e3.itemDistance, 20) : 0, l2 = this.maxLegendWidth, h2 = e3.alignColumns && this.totalItemWidth > l2 ? this.maxItemWidth : t3.itemWidth, d2 = t3.legendItem || {};
          ...
          adjustMargins(t3, e3) {
            ...
            o2 && [/(lth|ct|rth)/, /(rtv|rm|rbv)/, /(rbh|cb|lbh)/, /(lbv|lm|ltv)/].forEach(function(r2, a2) {
              r2.test(o2) && !m(t3[a2]) && (i3[c[a2]] = Math.max(i3[c[a2]], i3.legend[(a2 + 1) % 2 ? "legendHeight" : "legendWidth"] + [1, -1, -1, 1][a2] * s2[a2 % 2 ? "x" : "y"] + k(s2.margin, 12) + e3[a2] + (i3.titleOffset[a2] || 0)));
            });
          }
          proximatePositions() {
            let t3;
          ...
          handleOverflow(t3) {
            let e3 = this, i3 = this.chart, s2 = i3.renderer, o2 = this.options, r2 = o2.y, a2 = "top" === o2.verticalAlign, n2 = this.padding, l2 = o2.maxHeight, h2 = o2.navigation, d2 = k(h2.animation, true), c2 = h2.arrowSize || 12, p2 = this.pages, u2 = this.allItems, g2 = function(t4) {
            ...
            return "horizontal" !== o2.layout || "middle" === o2.verticalAlign || o2.floating || (b2 /= 2), l2 && (b2 = Math.min(b2, l2)), p2.length = 0, t3 && b2 > 0 && t3 > b2 && false !== h2.enabled ? (this.clipHeight = m2 = Math.max(b2 - 20 - this.titleHeight - n2, 0), this.currentPage = k(this.currentPage, 1), this.fullHeight = t3, u2.forEach((t4, e4) => {
        ...
        return (a = T || (T = {})).compose = function(t3) {
          M(d, "Core.Legend") && u(t3, "beforeMargins", function() {
        ...
        class X {
          ...
          setOptions(t3) {
            let e3;
            let i3 = this.chart, s2 = i3.options.plotOptions, o2 = i3.userOptions || {}, r2 = R(t3), a2 = i3.styledMode, n2 = { plotOptions: s2, userOptions: r2 };
            ...
            this.tooltipOptions = R(p.tooltip, p.plotOptions.series?.tooltip, c2?.tooltip, i3.userOptions.tooltip, h2.series?.tooltip, u2.tooltip, r2.tooltip), this.stickyTracking = G(r2.stickyTracking, u2.stickyTracking, d2.stickyTracking, !!this.tooltipOptions.shared && !this.noSharedTooltip || g2.stickyTracking), null === l2.marker && delete g2.marker, this.zoneAxis = g2.zoneAxis || "y";
          ...
          findPointIndex(t3, e3) {
            ...
            if (a2) {
              ...
              if (h2 && h2.matchByName ? e4 = (e5) => !e5.touched && e5.name === t3.name : this.options.relativeXValue && (e4 = (e5) => !e5.touched && e5.options.x === t3.x), !(i3 = P(l2, e4)))
                return;
            }
          ...
          setData(t3, e3 = true, i3, s2) {
            let o2 = this, r2 = o2.points, a2 = r2 && r2.length || 0, n2 = o2.options, l2 = o2.chart, h2 = n2.dataSorting, d2 = o2.xAxis, c2 = n2.turboThreshold, p2 = this.xData, u2 = this.yData, g2 = o2.pointArrayMap, f2 = g2 && g2.length, m2 = n2.keys, x2, y2, b2, v2 = 0, S2 = 1, k2 = null, M2;
            l2.options.chart.allowMutatingData || (n2.data && delete o2.options.data, o2.userOptions.data && delete o2.userOptions.data, M2 = R(true, t3));
            let C2 = (t3 = M2 || t3 || []).length;
            if (h2 && h2.enabled && (t3 = this.sortData(t3)), l2.options.chart.allowMutatingData && false !== s2 && C2 && a2 && !o2.cropped && !o2.hasGroupedData && o2.visible && !o2.boosted && (b2 = this.updateData(t3, i3)), !b2) {
              if (o2.xIncrement = null, o2.colorCounter = 0, this.parallelArrays.forEach(function(t4) {
                ...
                if (j(k2 = o2.getFirstValidPoint(t3)))
                  for (x2 = 0; x2 < C2; x2++)
              ...
              for (u2 && I(u2[0]) && w(14, true, l2), o2.data = [], o2.options.data = o2.userOptions.data = t3, x2 = a2; x2--; )
                r2[x2]?.destroy();
          ...
          getProcessedData(t3) {
            let e3 = this, i3 = e3.xAxis, s2 = e3.options.cropThreshold, o2 = i3?.logarithmic, r2 = e3.isCartesian, a2, n2, l2 = 0, h2, d2, c2, p2 = e3.xData, u2 = e3.yData, g2 = false, f2 = p2.length;
          ...
          generatePoints() {
            ...
            for (l2 && n2 && (this.options.keys = false), g2 = 0; g2 < r2; g2++)
              p2 = a2 + g2, n2 ? ((u2 = new o2(this, [i3[g2]].concat(W(s2[g2])))).dataGroup = this.groupMap[d2 + g2], u2.dataGroup.options && (u2.options = u2.dataGroup.options, T(u2, u2.dataGroup.options), delete u2.dataLabels)) : (u2 = f2[p2]) || void 0 === e3[p2] || (f2[p2] = u2 = new o2(this, e3[p2], i3[g2])), u2 && (u2.index = n2 ? d2 + g2 : p2, h2[g2] = u2);
          ...
          getExtremes(t3, e3) {
            ...
            for (i3 && (b2 = (d2 = i3.getExtremes()).min, v2 = d2.max), f2 = 0; f2 < k2; f2++)
              if (u2 = M2[f2], c2 = (j(g2 = t3[f2]) || B(g2)) && ((j(g2) ? g2 > 0 : g2.length) || !a2), p2 = e3 || this.getExtremesFromAll || this.options.getExtremesFromAll || this.cropped || !i3 || (M2[f2 + r2] || u2) >= b2 && (M2[f2 - r2] || u2) <= v2, c2 && p2) {
                if (m2 = g2.length)
                  for (; m2--; )
                    j(g2[m2]) && (o2[S2++] = g2[m2]);
                else
          ...
          translate() {
            ...
            for (p2 = 0; p2 < n2; p2++) {
              let t4;
              let n3 = a2[p2], y2 = n3.x, b2, S2, M2 = n3.y, C2 = n3.low, A2 = e3 && r2.stacking?.stacks[(this.negStacks && M2 < (c2 ? 0 : d2) ? "-" : "") + this.stackKey];
          ...
          getClipBox() {
            let { chart: t3, xAxis: e3, yAxis: i3 } = this, { x: s2, y: o2, width: r2, height: a2 } = R(t3.clipBox);
          ...
          markerAttribs(t3, e3) {
            ...
            let d2 = t3.pos();
            return j(h2) && d2 && (i3.crisp && (d2[0] = S(d2[0], t3.hasImage ? 0 : "rect" === r2 ? s2?.lineWidth || 0 : 1)), a2.x = d2[0] - h2, a2.y = d2[1] - h2), h2 && (a2.width = a2.height = 2 * h2), a2;
          }
          pointAttribs(t3, e3) {
          ...
          searchKDTree(t3, e3, i3) {
            ...
            if (this.kdTree || this.buildingKdTree || this.buildKDTree(i3), this.kdTree)
              return function t4(e4, i4, n3, h2) {
                ...
                !function(t5, e5) {
                  let i5 = t5[o2], s3 = e5[o2], a3 = k(i5) && k(s3) ? i5 - s3 : null, n4 = t5[r2], h3 = e5[r2], d3 = k(n4) && k(h3) ? n4 - h3 : 0, c3 = l2 && e5.marker?.radius || 0;
          ...
          update(t3, e3) {
            ...
            u2 = u2 || r2, g2 && (p2.push("data", "isDirtyData", "isDirtyCanvas", "points", "processedData", "processedXData", "processedYData", "xIncrement", "cropped", "_hasPointMarkers", "hasDataLabels", "nodes", "layout", "level", "mapMap", "mapData", "minY", "maxY", "minX", "maxX", "transformGroups"), false !== t3.visible && p2.push("area", "graph"), i3.parallelArrays.forEach(function(t4) {
              p2.push(t4 + "Data");
            }), t3.data && (t3.dataSorting && T(i3.options.dataSorting, t3.dataSorting), this.setData(t3.data, false))), t3 = R(o2, { index: void 0 === o2.index ? i3.index : o2.index, pointStart: a2?.series?.pointStart ?? o2.pointStart ?? i3.xData?.[0] }, !g2 && { data: i3.options.data }, t3, l2), g2 && t3.data && (t3.data = i3.options.data), (p2 = ["group", "markerGroup", "dataLabelsGroup", "transformGroup"].concat(p2)).forEach(function(t4) {
          ...
          hasOptionChanged(t3) {
            let e3 = this.chart, i3 = this.options[t3], s2 = e3.options.plotOptions, o2 = this.userOptions[t3], r2 = G(s2?.[this.type]?.[t3], s2?.series?.[t3]);
          ...
          setState(t3, e3) {
            ...
            if (t3 = t3 || "", i3.state !== t3 && ([i3.group, i3.markerGroup, i3.dataLabelsGroup].forEach(function(e4) {
              ...
              if (a2[t3] && false === a2[t3].enabled)
                return;
              if (t3 && (l2 = a2[t3].lineWidth || l2 + (a2[t3].lineWidthPlus || 0), h2 = G(a2[t3].opacity, h2)), o2 && !o2.dashstyle && j(l2))
        ...
        class Q {
          ...
          getContainer() {
            ...
            r2 || (this.renderTo = r2 = e3.renderTo), F(r2) && (this.renderTo = r2 = k.getElementById(r2)), r2 || I(13, true, this);
            let n2 = _(P(r2, i3));
            ...
            L(r2, { overflow: "hidden" }), this.styledMode || (o2 = R({ position: "relative", overflow: "hidden", width: d2 + "px", height: l2 + "px", textAlign: "left", lineHeight: "normal", zIndex: 0, "-webkit-tap-highlight-color": "rgba(0,0,0,0)", userSelect: "none", "touch-action": "manipulation", outline: "none" }, e3.style || {}));
            let c2 = O("div", { id: s2 }, o2, r2);
            this.container = c2, this.getChartSize(), d2 === this.chartWidth || (d2 = this.chartWidth, this.styledMode || L(c2, { width: V(e3.style?.width, d2 + "px") })), this.containerBox = this.getContainerBox(), this._cursor = c2.style.cursor;
          ...
          transform(t3) {
            let { axes: e3 = this.axes, event: i3, from: s2 = {}, reset: o2, selection: r2, to: a2 = {}, trigger: n2 } = t3, { inverted: l2 } = this, h2 = false, d2;
            for (let t4 of (this.hoverPoints?.forEach((t5) => t5.setState()), e3)) {
              let { horiz: e4, len: c2, minPointOffset: p2 = 0, options: u2, reversed: g2 } = t4, f2 = e4 ? "width" : "height", m2 = e4 ? "x" : "y", x2 = V(a2[f2], t4.len), y2 = V(s2[f2], t4.len), b2 = 10 > Math.abs(x2) ? 1 : x2 / y2, v2 = (s2[m2] || 0) + y2 / 2 - t4.pos, S2 = v2 - ((a2[m2] ?? t4.pos) + x2 / 2 - t4.pos) / b2, k2 = g2 && !l2 || !g2 && l2 ? -1 : 1;
              if (!o2 && (v2 < 0 || v2 > t4.len))
                continue;
              let M2 = t4.toValue(S2, true) + (r2 ? 0 : p2 * k2), C2 = t4.toValue(S2 + c2 / b2, true) - (r2 ? 0 : p2 * k2 || 0), A2 = t4.allExtremes;
              if (M2 > C2 && ([M2, C2] = [C2, M2]), 1 === b2 && !o2 && "yAxis" === t4.coll && !A2) {
              ...
              let { dataMin: w2, dataMax: T2, min: P2, max: O2 } = R(t4.getExtremes(), A2 || {}), L2 = w2 ?? u2.min, E2 = T2 ?? u2.max, B2 = C2 - M2, j2 = t4.categories ? 0 : Math.min(B2, E2 - L2), I2 = L2 - j2 * (D(u2.min) ? 0 : u2.minPadding), z2 = E2 + j2 * (D(u2.max) ? 0 : u2.maxPadding), G2 = t4.allowZoomOutside || 1 === b2 || "zoom" !== n2 && b2 > 1, N2 = Math.min(u2.min ?? I2, I2, G2 ? P2 : I2), W2 = Math.max(u2.max ?? z2, z2, G2 ? O2 : z2);
              (!t4.isOrdinal || 1 !== b2 || o2) && (M2 < N2 && (M2 = N2, b2 >= 1 && (C2 = M2 + B2)), C2 > W2 && (C2 = W2, b2 >= 1 && (M2 = C2 - B2)), (o2 || t4.series.length && (M2 !== P2 || C2 !== O2) && M2 >= N2 && C2 <= W2) && (r2 ? r2[t4.coll].push({ axis: t4, min: M2, max: C2 }) : (t4.isPanning = "zoom" !== n2, t4.setExtremes(o2 ? void 0 : M2, o2 ? void 0 : C2, false, false, { move: S2, trigger: n2, scale: b2 }), !o2 && (M2 > N2 || C2 < W2) && "mousewheel" !== n2 && (d2 = true)), h2 = true), i3 && (this[e4 ? "mouseDownX" : "mouseDownY"] = i3[e4 ? "chartX" : "chartY"]));
            }
            return h2 && (r2 ? G(this, "selection", r2, () => {
              delete t3.selection, t3.trigger = "zoom", this.transform(t3);
            }) : (d2 && !this.resetZoomButton ? this.showResetZoom() : !d2 && this.resetZoomButton && (this.resetZoomButton = this.resetZoomButton.destroy()), this.redraw("zoom" === n2 && (this.options.chart.animation ?? this.pointCount < 100)))), h2;
          }
        }
        ...
        class l extends s {
          ...
          getGraphPath(t3) {
            ...
            for (let s2 = 0, r3 = t3.length; s2 < r3; ++s2)
              l2 || (t3[s2].leftCliff = t3[s2].rightCliff = t3[s2].leftNull = t3[s2].rightNull = void 0), i3 = t3[s2].isNull, e3 = n(t3[s2].rectPlotX, t3[s2].plotX), o2 = l2 ? n(t3[s2].yBottom, f) : f, i3 && !m || (m || x(s2, s2 - 1, "left"), i3 && !l2 && m || (c.push(t3[s2]), d.push({ x: s2, plotX: e3, plotY: o2 })), m || x(s2, s2 + 1, "right"));
        ...
        return function(t3) {
          ...
          function x(t4) {
            ...
            l(this, "drawDataLabels"), i4.hasDataLabels?.() && (e4 = this.initDataLabels(M), t4.forEach((t5) => {
              ...
              f(b(y2, t5.dlOptions || t5.options?.dataLabels)).forEach((l3, c3) => {
                let f2 = l3.enabled && (t5.visible || t5.dataLabelOnHidden) && (!t5.isNull || t5.dataLabelOnNull) && function(t6, e5) {
                  ...
                  return true;
                }(t5, l3), { backgroundColor: m3, borderColor: y3, distance: b2, style: v2 = {} } = l3, S3, k2, M2, C, A = {}, w = o2[c3], T = !w, P;
                if (f2 && (k2 = u(l3[t5.formatPrefix + "Format"], l3.format), S3 = t5.getLabelConfig(), M2 = a(k2) ? r(k2, S3, s3) : (l3[t5.formatPrefix + "Formatter"] || l3.formatter).call(S3, l3), C = l3.rotation, !s3.styledMode && (v2.color = u(l3.color, v2.color, d(i4.color) ? i4.color : void 0, "#000000"), "contrast" === v2.color ? ("none" !== m3 && (P = m3), t5.contrastColor = h2.getContrast("auto" !== P && P || t5.color || i4.color), v2.color = P || !a(b2) && l3.inside || 0 > g(b2 || 0) || n2.stacking ? t5.contrastColor : x2) : delete t5.contrastColor, n2.cursor && (v2.cursor = n2.cursor)), A = { r: l3.borderRadius || 0, rotation: C, padding: l3.padding, zIndex: 1 }, s3.styledMode || (A.fill = "auto" === m3 ? t5.color : m3, A.stroke = "auto" === y3 ? t5.color : y3, A["stroke-width"] = l3.borderWidth), p(A, (t6, e5) => {
                  void 0 === t6 && delete A[e5];
                })), !w || f2 && a(M2) && !!w.div == !!l3.useHTML && (w.rotation && l3.rotation || w.rotation === l3.rotation) || (w = void 0, T = true), f2 && a(M2) && (w ? A.text = M2 : (w = h2.label(M2, 0, 0, l3.shape, void 0, void 0, l3.useHTML, void 0, "data-label")).addClass(" highcharts-data-label-color-" + t5.colorIndex + " " + (l3.className || "") + (l3.useHTML ? " highcharts-tracker" : "")), w)) {
          ...
          function o2() {
            ...
            t3.visible && t3.hasDataLabels?.() && (e4.forEach((t4) => {
              ...
              (t4.dataLabels || []).forEach((e5, i5) => {
                ...
                0 === i5 && m2[t4.half].push(t4), !p(o4?.style?.width) && e5.getBBox().width > a2 && (e5.css({ width: Math.round(0.7 * a2) + "px" }), e5.shortened = true), e5.dataLabelPosition = this.getDataLabelPosition(t4, r4), k = Math.max(k, r4);
              });
            }), m2.forEach((e5, a3) => {
              ...
              h2 && (t3.sortByAngle(e5, a3 - 0.5), k > 0 && (f2 = Math.max(0, g2 - c2 - k), m3 = Math.min(g2 + c2 + k, i4.plotHeight), e5.forEach((t4) => {
                ...
                (i5.dataLabels || []).forEach((l2) => {
                  let h3 = l2.options || {}, g3 = i5.distributeBox, f3 = l2.dataLabelPosition, m4 = f3?.natural.y || 0, b3 = h3.connectorPadding || 0, k2 = 0, M2 = m4, C = "inherit";
                  if (f3) {
                    if (d2 && p(g3) && f3.distance > 0 && (void 0 === g3.pos ? C = "hidden" : (S = g3.size, M2 = y.radialDistributionY(i5, l2))), h3.justify)
                      k2 = y.justify(i5, l2, c2, n2);
                    else
                      switch (h3.alignTo) {
                        case "connectors":
                          k2 = y.alignToConnectors(e5, a3, s3, r3);
                          break;
                        case "plotEdges":
                          k2 = y.alignToPlotEdges(l2, a3, s3, r3);
                          break;
                        default:
                          k2 = y.radialDistributionX(t3, i5, M2, m4, l2);
                      }
                    if (f3.attribs = { visibility: C, align: f3.alignment }, f3.posAttribs = { x: k2 + (h3.x || 0) + ({ left: b3, right: -b3 }[f3.alignment] || 0), y: M2 + (h3.y || 0) - l2.getBBox().height / 2 }, f3.computed.x = k2, f3.computed.y = M2, u(h3.crop, true)) {
                      let t4;
                      k2 - (v = l2.getBBox().width) < b3 && 1 === a3 ? (t4 = Math.round(v - k2 + b3), x[3] = Math.max(t4, x[3])) : k2 + v > s3 - b3 && 0 === a3 && (t4 = Math.round(k2 + v - s3 + b3), x[1] = Math.max(t4, x[1])), M2 - S / 2 < 0 ? x[0] = Math.max(Math.round(-M2 + S / 2), x[0]) : M2 + S / 2 > o3 && (x[2] = Math.max(Math.round(M2 + S / 2 - o3), x[2])), f3.sideOverflow = t4;
                    }
                  }
                });
              }));
        ...
        function x(t3, e3, i3, s2, o2 = {}) {
          ...
          if (s2 < u2 - f2) {
            ...
            y[0] = b[0] = t3 + i3 - u2 + o3, x2[0] = Math.min(y[0], x2[0]), m2[0] = Math.max(b[0], m2[0]), k[0] = M[0] = t3 + u2 - o3, b[1] = k[1] = e3;
          }
          return r2.length = 0, r2.push(["M", ...m2], ["L", ...x2], ["A", c2, c2, 0, 0, 1, ...y], ["L", ...b], ["A", u2, u2, 0, 0, 1, ...v], ["L", ...S], ["A", u2, u2, 0, 0, 1, ...k], ["L", ...M], ["A", c2, c2, 0, 0, 1, ...m2], ["Z"]), r2;
        }
      ...
      }), i(e, "masters/highcharts.src.js", [e["Core/Globals.js"], e["Core/Utilities.js"], e["Core/Defaults.js"], e["Core/Animation/Fx.js"], e["Core/Animation/AnimationUtilities.js"], e["Core/Renderer/HTML/AST.js"], e["Core/Templating.js"], e["Core/Renderer/RendererRegistry.js"], e["Core/Renderer/RendererUtilities.js"], e["Core/Renderer/SVG/SVGElement.js"], e["Core/Renderer/SVG/SVGRenderer.js"], e["Core/Renderer/HTML/HTMLElement.js"], e["Core/Axis/Axis.js"], e["Core/Axis/DateTimeAxis.js"], e["Core/Axis/LogarithmicAxis.js"], e["Core/Axis/PlotLineOrBand/PlotLineOrBand.js"], e["Core/Axis/Tick.js"], e["Core/Tooltip.js"], e["Core/Series/Point.js"], e["Core/Pointer.js"], e["Core/Legend/Legend.js"], e["Core/Legend/LegendSymbol.js"], e["Core/Chart/Chart.js"], e["Extensions/ScrollablePlotArea.js"], e["Core/Axis/Stacking/StackingAxis.js"], e["Core/Axis/Stacking/StackItem.js"], e["Core/Series/Series.js"], e["Core/Series/SeriesRegistry.js"], e["Series/Column/ColumnDataLabel.js"], e["Series/Pie/PieDataLabel.js"], e["Core/Series/DataLabel.js"], e["Extensions/OverlappingDataLabels.js"], e["Extensions/BorderRadius.js"], e["Core/Responsive.js"], e["Core/Color/Color.js"], e["Core/Time.js"]], function(t2, e2, i2, s, o, r, a, n, l, h, d, c, p, u, g, f, m, x, y, b, v, S, k, M, C, A, w, T, P, O, L, D, E, B, j, I) {
        return t2.AST = r, t2.Axis = p, t2.Chart = k, t2.Color = j, t2.DataLabel = L, t2.Fx = s, t2.HTMLElement = c, t2.Legend = v, t2.LegendSymbol = S, t2.OverlappingDataLabels = t2.OverlappingDataLabels || D, t2.PlotLineOrBand = f, t2.Point = y, t2.Pointer = b, t2.RendererRegistry = n, t2.Series = w, t2.SeriesRegistry = T, t2.StackItem = A, t2.SVGElement = h, t2.SVGRenderer = d, t2.Templating = a, t2.Tick = m, t2.Time = I, t2.Tooltip = x, t2.animate = o.animate, t2.animObject = o.animObject, t2.chart = k.chart, t2.color = j.parse, t2.dateFormat = a.dateFormat, t2.defaultOptions = i2.defaultOptions, t2.distribute = l.distribute, t2.format = a.format, t2.getDeferredAnimation = o.getDeferredAnimation, t2.getOptions = i2.getOptions, t2.numberFormat = a.numberFormat, t2.seriesType = T.seriesType, t2.setAnimation = o.setAnimation, t2.setOptions = i2.setOptions, t2.stop = o.stop, t2.time = i2.defaultTime, t2.timers = s.timers, E.compose(t2.Series, t2.SVGElement, t2.SVGRenderer), P.compose(t2.Series.types.column), L.compose(t2.Series), u.compose(t2.Axis), c.compose(t2.SVGRenderer), v.compose(t2.Chart), g.compose(t2.Axis), D.compose(t2.Chart), O.compose(t2.Series.types.pie), f.compose(t2.Axis), b.compose(t2.Chart), B.compose(t2.Chart), M.compose(t2.Axis, t2.Chart, t2.Series), C.compose(t2.Axis, t2.Chart, t2.Series), x.compose(t2.Pointer), e2.extend(t2, e2), t2;
        ...
        let { defaultOptions: l } = i2, { isTouchDevice: h } = s, { addEvent: d, clamp: c, correctFloat: p, defined: u, destroyObjectProperties: g, erase: f, extend: m, find: x, fireEvent: y, isArray: b, isNumber: v, merge: S, pick: k, removeEvent: M, splat: C } = n;
        function A(t3, ...e3) {
        ...
        class w {
          ...
          render(t3, e3, i3, s2) {
            let o2 = this.chart, r2 = this.xAxis, a2 = r2.pointRange || 0, n2 = r2.navigatorAxis.fake ? o2.xAxis[0] : r2, l2 = this.navigatorEnabled, h2 = this.rendered, d2 = o2.inverted, g2 = o2.xAxis[0].minRange, f2 = o2.xAxis[0].options.maxRange, m2 = this.scrollButtonSize, x2, b2, S2, M2 = this.scrollbarHeight, C2, A2;
            ...
            this.left = k(r2.left, o2.plotLeft + m2 + (d2 ? o2.plotWidth : 0));
            let w2 = this.size = C2 = k(r2.len, (d2 ? o2.plotHeight : o2.plotWidth) - 2 * m2);
            x2 = d2 ? M2 : C2 + 2 * m2, i3 = k(i3, r2.toPixels(t3, true)), s2 = k(s2, r2.toPixels(e3, true)), v(i3) && Math.abs(i3) !== 1 / 0 || (i3 = 0, s2 = x2);
            let T = r2.toValue(i3, true), P = r2.toValue(s2, true), O = Math.abs(p(P - T));
            O < g2 ? this.grabbedLeft ? i3 = r2.toPixels(P - g2 - a2, true) : this.grabbedRight && (s2 = r2.toPixels(T + g2 + a2, true)) : u(f2) && p(O - a2) > f2 && (this.grabbedLeft ? i3 = r2.toPixels(P - f2 - a2, true) : this.grabbedRight && (s2 = r2.toPixels(T + f2 + a2, true))), this.zoomedMax = c(Math.max(i3, s2), 0, w2), this.zoomedMin = c(this.fixedWidth ? this.zoomedMax - this.fixedWidth : Math.min(i3, s2), 0, w2), this.range = this.zoomedMax - this.zoomedMin, w2 = Math.round(this.zoomedMax);
            let L = Math.round(this.zoomedMin);
            l2 && (this.navigatorGroup.attr({ visibility: "inherit" }), A2 = h2 && !this.hasDragged ? "animate" : "attr", this.drawMasks(L, w2, d2, A2), this.drawOutline(L, w2, d2, A2), this.navigatorOptions.handles.enabled && (this.drawHandle(L, 0, d2, A2), this.drawHandle(w2, 1, d2, A2))), this.scrollbar && (d2 ? (S2 = this.top - m2, b2 = this.left - M2 + (l2 || !n2.opposite ? 0 : (n2.titleOffset || 0) + n2.axisTitleMargin), M2 = C2 + 2 * m2) : (S2 = this.top + (l2 ? this.height : -M2), b2 = this.left - m2), this.scrollbar.position(b2, S2, x2, M2), this.scrollbar.setRange(this.zoomedMin / (C2 || 1), this.zoomedMax / (C2 || 1))), this.rendered = true, y(this, "afterRender");
          }
          addMouseEvents() {
          ...
          onMouseMove(t3) {
            ...
            (!t3.touches || 0 !== t3.touches[0].pageX) && (l2 = (t3 = i3.pointer?.normalize(t3) || t3).chartX, a2 && (n2 = e3.top, l2 = t3.chartY), e3.grabbedLeft ? (e3.hasDragged = true, e3.render(0, 0, l2 - n2, e3.otherHandlePos)) : e3.grabbedRight ? (e3.hasDragged = true, e3.render(0, 0, e3.otherHandlePos, l2 - n2)) : e3.grabbedCenter && (e3.hasDragged = true, l2 < r2 ? l2 = r2 : l2 > s2 + r2 - o2 && (l2 = s2 + r2 - o2), e3.render(0, 0, l2 - r2, l2 - r2 + o2)), e3.hasDragged && e3.scrollbar && k(e3.scrollbar.options.liveRedraw, !h && !this.chart.boosted) && (t3.DOMType = t3.type, setTimeout(function() {
              e3.onMouseUp(t3);
            }, 0)));
          }
          onMouseUp(t3) {
          ...
          removeBaseSeriesEvents() {
            ...
            this.navigatorEnabled && t3[0] && (false !== this.navigatorOptions.adaptToUpdatedData && t3.forEach(function(t4) {
              M(t4, "updatedData", this.updatedDataHandler);
            }, this), t3[0].xAxis && M(t3[0].xAxis, "foundExtremes", this.modifyBaseAxisExtremes));
          }
          init(e3) {
            ...
            this.handles = [], this.shades = [], this.chart = e3, this.setBaseSeries(), this.height = h2, this.scrollbarHeight = c2, this.scrollButtonSize = p2, this.scrollbarEnabled = l2, this.navigatorEnabled = r2, this.navigatorOptions = s2, this.scrollbarOptions = n2, this.opposite = k(s2.opposite, !!(!r2 && e3.inverted));
            let u2 = this, g2 = u2.baseSeries, f2 = e3.xAxis.length, m2 = e3.yAxis.length, x2 = g2 && g2[0] && g2[0].xAxis || e3.xAxis[0] || { options: {} };
            if (e3.isDirtyBox = true, u2.navigatorEnabled ? (u2.xAxis = new t2(e3, S({ breaks: x2.options.breaks, ordinal: x2.options.ordinal, overscroll: x2.options.overscroll }, s2.xAxis, { type: "datetime", index: f2, isInternal: true, offset: 0, keepOrdinalPadding: true, startOnTick: false, endOnTick: false, minPadding: 0, maxPadding: 0, zoomEnabled: false }, e3.inverted ? { offsets: [p2, 0, -p2, 0], width: h2 } : { offsets: [0, -p2, 0, p2], height: h2 }), "xAxis"), u2.yAxis = new t2(e3, S(s2.yAxis, { alignTicks: false, offset: 0, index: m2, isInternal: true, reversed: k(s2.yAxis && s2.yAxis.reversed, e3.yAxis[0] && e3.yAxis[0].reversed, false), zoomEnabled: false }, e3.inverted ? { width: h2 } : { height: h2 }), "yAxis"), g2 || s2.series.data ? u2.updateNavigatorSeries(false) : 0 === e3.series.length && (u2.unbindRedraw = d(e3, "beforeRedraw", function() {
          ...
          getUnionExtremes(t3) {
            ...
            return t3 && null === i3.dataMin || (e3 = { dataMin: k(o2 && o2.min, A("min", r2.min, i3.dataMin, s2.dataMin, s2.min)), dataMax: k(o2 && o2.max, A("max", r2.max, i3.dataMax, s2.dataMax, s2.max)) }), e3;
          }
          setBaseSeries(t3, e3) {
          ...
          updateNavigatorSeries(t3, e3) {
            let i3 = this, s2 = i3.chart, o2 = i3.baseSeries, r2 = { enableMouseTracking: false, index: null, linkedTo: null, group: "nav", padXAxis: false, xAxis: this.navigatorOptions.xAxis?.id, yAxis: this.navigatorOptions.yAxis?.id, showInLegend: false, stacking: void 0, isInternal: true, states: { inactive: { opacity: 1 } } }, a2 = i3.series = (i3.series || []).filter((t4) => {
              let e4 = t4.baseSeries;
              return !(0 > o2.indexOf(e4)) || (e4 && (M(e4, "updatedData", i3.updatedDataHandler), delete e4.navigatorSeries), t4.chart && t4.destroy(), false);
            ...
            o2 && o2.length && o2.forEach((t4) => {
              ...
              if (p2 && false === i3.navigatorOptions.adaptToUpdatedData)
                return;
              r2.name = "Navigator " + o2.length, c2 = (n2 = t4.options || {}).navigatorOptions || {}, u2.dataLabels = C(u2.dataLabels), (h2 = S(n2, r2, u2, c2)).pointRange = k(u2.pointRange, c2.pointRange, l.plotOptions[h2.type || "line"].pointRange);
          ...
          modifyBaseAxisExtremes() {
            let t3, e3;
            let i3 = this.chart.navigator, s2 = this.getExtremes(), o2 = s2.min, r2 = s2.max, a2 = s2.dataMin, n2 = s2.dataMax, l2 = r2 - o2, h2 = i3.stickToMin, d2 = i3.stickToMax, c2 = k(this.ordinal?.convertOverscroll(this.options.overscroll), 0), p2 = i3.series && i3.series[0], u2 = !!this.setExtremes;
        ...
        return function(t3) {
          function s2(t4, e3, i3, s3, o3 = [], r2 = 0, a2) {
            ...
            let k2 = o3.length;
            for (g2 = 0; g2 < k2; g2++) {
              if (y2 = g2 && o3[g2 - 1] > i3, o3[g2] < e3 && (b2 = g2), g2 === k2 - 1 || o3[g2 + 1] - o3[g2] > 5 * r2 || y2) {
                if (o3[g2] > S2) {
            ...
            if (a2 && l(d2)) {
              ...
              for (s4.sort((t6, e5) => t6 - e5), (l2 = s4[Math.floor(s4.length / 2)]) < 0.6 * d2 && (l2 = null), c3 = v2[t5 - 1] > i3 ? t5 - 1 : t5, a3 = void 0; c3--; )
          ...
          t3.compose = function(t4, e3, i3) {
            let a2 = t4.prototype;
            return a2.ordinal2lin || (a2.getTimeTicks = s2, a2.index2val = o2, a2.lin2val = g, a2.val2lin = k, a2.ordinal2lin = a2.val2lin, r(t4, "afterInit", m), r(t4, "foundExtremes", x), r(t4, "afterSetScale", y), r(t4, "initialAxisTranslation", b), r(i3, "pan", v), r(e3, "updatedData", S)), t4;
          };
          class M {
            constructor(t4) {
        ...
        class C {
          ...
          clickButton(t2, i3) {
            ...
            if (null !== d2 && null !== c2) {
              if (this.setSelected(t2), l2 && (this.forcedDataGrouping = true, e2.prototype.setDataGrouping.call(r2 || { chart: this.chart }, l2, false), this.frozenStates = o2.preserveDataGrouping), "month" === n2 || "year" === n2)
                r2 ? (v2 = { range: o2, max: g2, chart: s2, dataMin: d2, dataMax: c2 }, u2 = r2.minFromRange.call(v2), x(v2.newMax) && (g2 = v2.newMax), C2 = false) : y2 = o2;
              else if (y2)
                g2 = Math.min((u2 = Math.max(g2 - y2, d2)) + y2, c2), C2 = false;
              else if ("ytd" === n2) {
                if (r2)
                  (void 0 === c2 || void 0 === d2) && (d2 = Number.MAX_VALUE, c2 = Number.MIN_VALUE, s2.series.forEach((t3) => {
                    let e3 = t3.xData;
                ...
                "all" === n2 && r2 && (s2.navigator && s2.navigator.baseSeries[0] && (s2.navigator.baseSeries[0].xAxis.options.range = void 0), u2 = d2, g2 = c2);
              if (C2 && o2._offsetMin && p(u2) && (u2 += o2._offsetMin), o2._offsetMax && p(g2) && (g2 += o2._offsetMax), this.dropdown && (this.dropdown.selectedIndex = t2 + 1), r2)
                r2.setExtremes(u2, g2, S(i3, true), void 0, { trigger: "rangeSelectorButton", rangeSelectorButton: o2 }), s2.setFixedRange(o2._range);
              else {
          ...
          updateButtonStates() {
            ...
            t2.buttonOptions.forEach((e4, i4) => {
              ...
              if (g3 && x2 && (M2 = true), o2.isOrdinal && o2.ordinal?.positions && s3 && r2 < s3) {
                ...
                ("month" === l2 || "year" === l2) && r2 + 36e5 >= { month: 28, year: 365 }[l2] * h2 * d3 - c2 && r2 - 36e5 <= { month: 31, year: 366 }[l2] * h2 * d3 + c2 ? w = true : "ytd" === l2 ? (w = m2 - f2 + c2 === r2, A = !g3) : "all" === l2 && (w = o2.max - o2.min >= u2 - p2);
          ...
          drawInput(t2) {
            ...
            function g2(t3) {
              let { maxInput: i4, minInput: s2 } = r2, o3 = e3.xAxis[0], a3 = e3.scroller?.getUnionExtremes() || o3, n3 = a3.dataMin, l2 = a3.dataMax, h3 = e3.xAxis[0].getExtremes()[t3], d2 = r2.getInputValue(t3);
          ...
          createElements() {
            let t2 = this.chart, e3 = t2.renderer, i3 = t2.container, s2 = t2.options, o2 = s2.rangeSelector, r2 = o2.inputEnabled, a2 = S(s2.chart.style?.zIndex, 0) + 1;
          ...
          renderButtons() {
            ...
            let p2 = this.dropdown = d("select", void 0, { position: "absolute", padding: 0, border: 0, cursor: "pointer", opacity: 1e-4 }, this.div), u2 = e3.userOptions.rangeSelector?.buttonTheme;
            this.dropdownLabel = r2.button("", 0, 0, () => {
            }, y(a2, { "stroke-width": S(a2["stroke-width"], 0), width: "auto", paddingLeft: S(i3.buttonTheme.paddingLeft, u2?.padding, 8), paddingRight: S(i3.buttonTheme.paddingRight, u2?.padding, 8) }), n2 && n2.hover, n2 && n2.select, n2 && n2.disabled).hide().add(this.group), h(p2, "touchstart", () => {
          ...
          alignElements() {
            ...
            if (s2 && h2 && d2) {
              ...
              if (t2) {
                ...
                u2 -= i3.spacing[3];
                let o3 = p2(t2, h2);
                this.alignButtonGroup(o3), this.buttonGroup?.translateY && this.dropdownLabel.attr({ y: this.buttonGroup.translateY }), s2.placed = t2.placed = i3.hasLoaded;
              }
              let l3 = 0;
          ...
          function r2(t4) {
            ...
            if (s3.options.isStock && false !== t4.acrossPanes && "xAxis" === e4.coll || "yAxis" === e4.coll) {
              for (let o4 of (t4.preventDefault(), S2 = ((t5) => {
                ...
                if (!g(o4.options.id) || -1 === o4.options.id.indexOf("navigator")) {
                  let t5 = o4.isXAxis ? "yAxis" : "xAxis";
                  e4 === (g(o4.options[t5]) ? s3[t5][o4.options[t5]] : s3[t5][0]) && S2.push(o4);
                }
              for (let t5 of (k2 = S2.length ? [] : [e4.isXAxis ? s3.yAxis[0] : s3.xAxis[0]], S2))
                -1 !== k2.indexOf(t5) || m(k2, (e5) => e5.pos === t5.pos && e5.len === t5.len) || k2.push(t5);
        ...
        return function(t3) {
          ...
          function i3() {
            ...
            if (r2 && r2.visible && y) {
              for (b = (r2.pointXOffset || 0) + (r2.barW || 0) / 2, M = r2.currentDataGrouping, S = h2[y - 1].x + (M ? M.totalRange : 0), d(s2, (t5, e5) => t5.x - e5.x), x = "plot" + x[0].toUpperCase() + x.substr(1); y-- && s2[g]; )
                if (v = h2[y], (f = s2[g]).y = v.y, v.x <= f.x && void 0 !== v[x]) {
                  if (f.x <= S && (f.plotY = v[x], v.x < f.x && !n2 && (k = h2[y + 1]) && void 0 !== k[x])) {
                    if (l(f.plotX) && r2.is("spline")) {
                      let t5 = [v.plotX || 0, v.plotY || 0], e5 = [k.plotX || 0, k.plotY || 0], i5 = v.controlPoints?.high || t5, s3 = k.controlPoints?.low || e5, o3 = (o4, r4) => Math.pow(1 - o4, 3) * t5[r4] + 3 * (1 - o4) * (1 - o4) * o4 * i5[r4] + 3 * (1 - o4) * o4 * o4 * s3[r4] + o4 * o4 * o4 * e5[r4], r3 = 0, a2 = 1, n3;
                      ...
                      C = (f.x - v.x) / (k.x - v.x), f.plotY += C * (k[x] - v[x]), f.y += C * (k.y - v.y);
                  }
                  if (g--, y++, g < 0)
                    break;
                }
        ...
        function f(t3) {
          ...
          if (A && v2 && v2.length && k) {
            ...
            for (d2 && d2.smoothed && T.length && (d2.firstAnchor = "firstPoint", d2.anchor = "middle", d2.lastAnchor = "lastPoint", h(32, false, n2, { "dataGrouping.smoothed": "use dataGrouping.anchor" })), o2 = 1; o2 < b3.length; o2++)
              b3.info.segmentStarts && -1 !== b3.info.segmentStarts.indexOf(o2) || (O = Math.max(b3[o2] - b3[o2 - 1], O));
            ...
            this.groupMap = null, this.currentDataGrouping = void 0;
          ...
          for (let t3 = 0; t3 <= g2; t3++)
            if (!(e3[t3] < s2[0])) {
              ...
              if (x2) {
                ...
                c(k = f2 ? i3[t3] : null) ? m2[0].push(k) : null === k && (m2[0].hasNulls = true);
            }
