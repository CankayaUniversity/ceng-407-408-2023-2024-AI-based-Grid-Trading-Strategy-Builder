...
// Plotly.js'ı TypeScript dosyasında kullanabilmek için bildirin
...
export class DashboardComponent implements AfterViewInit {
  ...
  ngAfterViewInit() {
    this.renderer.listen('window', 'DOMContentLoaded', () => {
      console.log('test');
      // Bileşenin içindeki elementi seçmek için ElementRef'i kullanın
      ...
      // Seçilen elemente yeni bir grafik oluşturun
